...
## Install the private rubygem package

```bash
gem install azure-storage-common-1.1.0.gem
gem install azure-storage-blob-1.1.0.gem
gem install azure-storage-queue-1.1.0.gem
```
